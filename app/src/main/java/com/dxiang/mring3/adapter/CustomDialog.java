...
public class CustomDialog extends Dialog {
	...
	public static class Builder {
		...
		public Builder setMessage(String message, int setContentStyle) {
		 ...
		 * @return
		 */
		public Builder setMessage(int message, int setContentStyle) {

...
import com.dxiang.mring3.adapter.CustomDialogUpdate.Builder;
...
public class UserCenterDialog extends Dialog {
	...
	public UserCenterDialog(Context context, int theme) {
		super(context, theme);
	}
	...
	public static class Builder {
		...
		public CustomDialogUpdate create() {
			...
			View layout = inflater.inflate(R.layout.dialog_userconter, null);

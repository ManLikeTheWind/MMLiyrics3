...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (a.hasValue(R.styleable.PullToRefreshs_mode)) {
			mode = a.getInteger(R.styleable.PullToRefreshs_mode,
		...
		String pushLabel = context
				.getString(R.string.pull_to_load_release_label);
		String loadingLabel = context
				.getString(R.string.pull_to_load_loading_label);
		String releaseLoadLabel = context
		...
		if (mode == MODE_PULL_UP_TO_REFRESH || mode == MODE_BOTH) {
			footerLayout = new LoadingLayout(context, MODE_PULL_UP_TO_REFRESH,
					pushLabel, releaseLoadLabel, loadingLabel, true);
		...
		// Styleables from XML
		if (a.hasValue(R.styleable.PullToRefreshs_headerTextColor)) {
			final int color = a.getColor(
					R.styleable.PullToRefreshs_headerTextColor, Color.BLACK);
			if (null != headerLayout) {
		...
		if (a.hasValue(R.styleable.PullToRefreshs_headerBackground)) {
			this.setBackgroundResource(a.getResourceId(
					R.styleable.PullToRefreshs_headerBackground, Color.WHITE));
		}
		if (a.hasValue(R.styleable.PullToRefreshs_adapterViewBackground)) {
			refreshableView.setBackgroundResource(a.getResourceId(
					R.styleable.PullToRefreshs_adapterViewBackground,
					Color.WHITE));
		}
		a.recycle();
	...
	public void setRefreshTime(String refresh_time) {
		headerLayout.setRefreshTime(refresh_time);
